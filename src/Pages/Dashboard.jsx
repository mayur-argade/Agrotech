  ...
  return (
    <div className="m-0">
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="lg:col-start-1 lg:col-end-3 col-start-1 col-end-13 mx-5">
          <Sidebar />
        </div>
        
        <div className="lg:col-start-3 lg:col-end-12 col-start-1 col-end-13 pl-5">
          <div className="line1 flex rounded-md shadow bg-emerald-300">
            <div class="stats rounded bg-emerald-300">
              <div class="stat">
                <div class="stat-value">{event.pintensity}</div>
            ...
            <div class="stats rounded bg-emerald-300">
              <div class="stat">
                <div class="stat-value">{event.pprobability}</div>
            ...
            <div class="stats rounded bg-emerald-300">
              <div class="stat">
                <div class="stat-value">{event.pressure}</div>bar
            ...
            <div class="stats rounded bg-emerald-300">
              <div class="stat">
                <div class="stat-value">{event.wspeed}</div>
            ...
            <div class="stats rounded bg-emerald-300">
              <div class="stat">
                <div class="stat-value">{event.wdirection}</div>
                <div class="stat-title font-medium">Wind Direction</div>
              </div>
            </div>

            <div class="stats rounded-md bg-emerald-300">
              <div class="stat">
                ...
                <div class="stat-value">{event.wtemp}</div>
                <div class="stat-title font-medium">Windy</div>
              </div>
            </div>
          </div>

          <div className="content justify-evenly flex pt-5">

            <div className="left">
              <div className="text-4xl font-semibold">Sensor</div>
            ...
            <iframe className="rounded-xl" width="520" height="386" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=386&amp;hl=en&amp;q=pimplegaon%20pune+(pimpalgaon)&amp;t=k&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='https://add-map.com/'></a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=0be1ddff42e0997de165b8ff4033d38efb3890f2'></script>
            </div>
          </div>
        </div>
      </div>
